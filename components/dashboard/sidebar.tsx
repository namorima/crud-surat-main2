...
const navigation = [
  { name: "Dashboard", href: "/dashboard", icon: Home, roles: ["semua", "admin", "PERLADANGAN", "PENGURUS"] },
  { name: "Surat", href: "/dashboard/surat", icon: FileText, roles: ["semua", "admin", "PERLADANGAN", "PENGURUS"] },
  ...
  { name: "Tetapan", href: "/dashboard/tetapan", icon: Settings, roles: ["semua", "admin"] },
]
...
export function Sidebar() {
  ...
  const filteredNavigation =
    user?.role === "KEWANGAN"
      ? navigation.filter((item) => item.name === "Bayaran")
